...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    let matches = Command::new("ETL-Query script")
        ...
        .subcommand(
            Command::new("extract")
                .about("Extracts data from the URL and saves it locally"),
        )
        .subcommand(
            Command::new("transform_load")
                .about("Transforms and loads data into the database"),
        )
        .subcommand(
        ...
        .subcommand(
            Command::new("read_data")
                .about("Reads all data from the database"),
        )
        .get_matches();
